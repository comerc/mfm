...
### Результаты проверочного запуска

(tmp) ➜  tmp git:(main) ✗ python check_vit.py 1.png
🔍 Начинаю проверку файла: 1.png
⚙️ Загрузка ONNX модели...
🖼️ Чтение и ресайз изображения...
🧪 Нормализация ImageNet...
🧠 Запуск нейросети...

--- [ РЕЗУЛЬТАТ ] ---
🔞 NSFW Вероятность: 0.9973
📢 Вердикт: NSFW
----------------------

(tmp) ➜  tmp git:(main) ✗ python check_vit.py 2.png
🔍 Начинаю проверку файла: 2.png
⚙️ Загрузка ONNX модели...
🖼️ Чтение и ресайз изображения...
🧪 Нормализация ImageNet...
🧠 Запуск нейросети...
...
--- [ РЕЗУЛЬТАТ ] ---
🔞 NSFW Вероятность: 0.1773
📢 Вердикт: SAFE
----------------------

(tmp) ➜  tmp git:(main) ✗ python check_vit.py 3.png
🔍 Начинаю проверку файла: 3.png
⚙️ Загрузка ONNX модели...
🖼️ Чтение и ресайз изображения...
🧪 Нормализация ImageNet...
🧠 Запуск нейросети...
...
--- [ РЕЗУЛЬТАТ ] ---
🔞 NSFW Вероятность: 0.4297
📢 Вердикт: SAFE
----------------------

(tmp) ➜  tmp git:(main) ✗ python check_vit.py 4.png
🔍 Начинаю проверку файла: 4.png
⚙️ Загрузка ONNX модели...
🖼️ Чтение и ресайз изображения...
🧪 Нормализация ImageNet...
🧠 Запуск нейросети...
...
--- [ РЕЗУЛЬТАТ ] ---
🔞 NSFW Вероятность: 0.0231
📢 Вердикт: SAFE
----------------------

(tmp) ➜  tmp git:(main) ✗ python check_vit.py 5.png
🔍 Начинаю проверку файла: 5.png
⚙️ Загрузка ONNX модели...
🖼️ Чтение и ресайз изображения...
🧪 Нормализация ImageNet...
🧠 Запуск нейросети...
...
--- [ РЕЗУЛЬТАТ ] ---
🔞 NSFW Вероятность: 0.0004
📢 Вердикт: SAFE
----------------------

(tmp) ➜  tmp git:(main) ✗ python check_vit.py 6.png
🔍 Начинаю проверку файла: 6.png
⚙️ Загрузка ONNX модели...
🖼️ Чтение и ресайз изображения...
🧪 Нормализация ImageNet...
🧠 Запуск нейросети...
...
--- [ РЕЗУЛЬТАТ ] ---
🔞 NSFW Вероятность: 0.9981
📢 Вердикт: NSFW
----------------------

(tmp) ➜  tmp git:(main) ✗ python check_vit.py 7.png
🔍 Начинаю проверку файла: 7.png
⚙️ Загрузка ONNX модели...
🖼️ Чтение и ресайз изображения...
🧪 Нормализация ImageNet...
🧠 Запуск нейросети...
